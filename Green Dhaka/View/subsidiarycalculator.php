    ...
    <table border="0" width = "100%" height = "100%">
            <tr >
                ...
                <table border="1" align="center">
                    <tr>
                        ...
                        <td align="right"> Hi Arnab Bishakh <br>
                             <a href=""> Account <a>
            ...
            <tr>
                <td colspan="3" align="center" height ="8%">
                    <a href="">Garden Registration</a>
                    <a href="">Solar Panel Registration</a>
                    <a href="">News feed</a>
                    <a href="">Subsidiary Calculator</a>
                    <a href="">E-shop</a>
                    <a href="">Donation</a>
                    <a href="">Hiring a Gardener</a>
                    <a href="">Expert opinion</a>
            ...
            <br> </p>
                ...
                <tr align ="left">
                    ...
                    <td>
                    <textarea cols="20" rows="4" name="address" ></textarea><br>
                    </td>
                ...
                <tr align ="left">
                    ...
                    <td>
                   <input type="number" name="rooftopArea" value=""><br>
                    </td>
                ...
                <tr align ="left">
                    ...
                    <td>
                    <input type="number" name="gardenArea" value=""><br>
                    </td>
                ...
                <tr align ="left">
                    ...
                    <td>
                     <input type="number" name="solarPanelArea" value=""><br>
                    </td>
                
                </table>
                <br>
                Sub Reduction Rate
                <input type="number" name="taxReduction" value=""><br>
